...
- **Автоматичне перепідключення** до Deye інвертора при втраті з'єднання
- **Розумне керування** - команди надсилаються тільки при зміні стану
- **Детальне логування** - повна інформація про стан обох пристроїв
- **Повторні спроби** - до 5 спроб при помилках з'єднання
- **Безпечне завершення** - коректне закриття з'єднань при Ctrl+C
...
```
2025-11-18 17:48:38,321 - INFO - ============================================================
2025-11-18 17:48:38,321 - INFO - Запуск системи керування зарядкою Feyree EV
2025-11-18 17:48:38,321 - INFO - ============================================================
2025-11-18 17:48:38,321 - INFO - Порогові значення:
2025-11-18 17:48:38,321 - INFO -   - Мінімальний SOC для зарядки: 90.0%
2025-11-18 17:48:38,321 - INFO -   - Максимальний імпорт з мережі: 250.0W
2025-11-18 17:48:38,321 - INFO -   - Інтервал перевірки: 120 сек
2025-11-18 17:48:38,321 - INFO -   - Сила струму зарядки: 16A
2025-11-18 17:48:38,321 - INFO - ============================================================
2025-11-18 17:48:38,343 - INFO - Deye інвертор: підключення до 172.16.32.50:8899 (SN: 00000000)
2025-11-18 17:48:38,343 - INFO - Feyree зарядка: підключення до 172.16.32.48 (ID: 00000000000000000)
2025-11-18 17:48:38,343 - INFO - ------------------------------------------------------------
2025-11-18 17:48:38,343 - INFO - Перевірка підключення до пристроїв...
2025-11-18 17:48:38,343 - INFO - ------------------------------------------------------------
2025-11-18 17:48:38,343 - INFO - Тестове підключення до Deye інвертора...
2025-11-18 17:48:38,471 - INFO - Deye інвертор: Підключення УСПІШНЕ
2025-11-18 17:48:38,472 - INFO -   Поточний SOC: 90.0%
2025-11-18 17:48:38,472 - INFO -   Потужність мережі: 162W (import)
2025-11-18 17:48:38,472 - INFO - Тестове підключення до Feyree зарядки...
2025-11-18 17:48:38,549 - INFO - Feyree зарядка: Підключення УСПІШНЕ
2025-11-18 17:48:38,549 - INFO -   Стан: ВВІМК
2025-11-18 17:48:38,550 - INFO -   Режим: charge_now
2025-11-18 17:48:38,550 - INFO - Всі пристрої підключені успішно. Запуск основного циклу...
2025-11-18 17:48:38,550 - INFO - ------------------------------------------------------------
2025-11-18 17:48:38,550 - INFO - Ітерація #1 - 2025-11-18 17:48:38
2025-11-18 17:48:38,550 - INFO - Читання даних з Deye інвертора...
2025-11-18 17:48:38,672 - INFO - Стан системи:
2025-11-18 17:48:38,672 - INFO -   - Батарея: 90.0%
2025-11-18 17:48:38,672 - INFO -   - Мережа: 162W (import)
2025-11-18 17:48:38,672 - INFO - Аналіз умов зарядки:
2025-11-18 17:48:38,672 - INFO -   - SOC >= 90.0%: ТАК
2025-11-18 17:48:38,673 - INFO -   - Імпорт < 250.0W або експорт: ТАК
2025-11-18 17:48:38,673 - INFO - Рішення: УВІМКНУТИ зарядку
2025-11-18 17:48:38,673 - INFO - Отримання стану пристрою...
2025-11-18 17:48:38,691 - INFO - [ДО] Стан пристрою Feyree:
2025-11-18 17:48:38,691 - INFO -   └─ DPS 18 (switch): ВВІМК
2025-11-18 17:48:38,691 - INFO -   └─ DPS 14 (work_mode): charge_now
2025-11-18 17:48:38,691 - INFO -   └─ DPS 101 (charge_status): charing
2025-11-18 17:48:38,692 - INFO -   └─ DPS 124 (mode_status): CloseCharging
2025-11-18 17:48:38,692 - INFO -   └─ DPS 114 (current): 16A
2025-11-18 17:48:38,692 - INFO -   └─ DPS 115 (max_current): 16A
2025-11-18 17:48:38,692 - INFO -   └─ DPS 102 (energy): 2.137 kWh
2025-11-18 17:48:38,692 - INFO -   └─ DPS 120 (time): 00:44:34
2025-11-18 17:48:38,692 - INFO - Зарядка вже відбувається (DPS 101 = charing)
2025-11-18 17:48:38,693 - INFO - Очікування 120 секунд до наступної перевірки...
```
...
### З'єднання з інвертором закривається

```
ERROR - З'єднання з інвертором закрите: Connection already closed.
WARNING - Спроба перепідключення до Deye інвертора...
```

**Рішення:**
- Це нормальна ситуація - система **автоматично перепідключається**
- З'єднання може закриватись після тривалих операцій з Feyree зарядкою
- Система спробує перепідключитись до 5 разів (налаштовується через `MAX_ATTEMPTS`)
- Якщо проблема постійна, збільште `CONNECTION_TIMEOUT_SEC` або `RETRY_DELAY_SEC`
...
### Технічна інформація: DPS коди Feyree

Система використовує такі ключові DPS коди для керування зарядкою:

**Для увімкнення зарядки:**
1. `DPS 18 = True` - увімкнути перемикач
2. `DPS 14 = "charge_now"` - встановити режим зарядки
3. `DPS 123 = True` - **запустити процес зарядки** (ключова команда)
4. `DPS 10 = 1` - додатковий параметр

**Для вимкнення зарядки:**
1. `DPS 123 = False` - **зупинити процес зарядки** (ключова команда)
2. `DPS 18 = False` - вимкнути перемикач

**Моніторинг стану:**
- `DPS 101` - статус зарядки ("finish", "charing")
- `DPS 114` - поточний струм (A)
- `DPS 102` - енергія (kWh)
- `DPS 120` - час зарядки

> **Важливо:** DPS 123 є критичним для реального запуску/зупинки зарядки. Без цього DPS зарядка може не розпочатись або не зупинитись навіть при зміні DPS 18.
